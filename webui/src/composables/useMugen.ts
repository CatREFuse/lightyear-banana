...
import { createDefaultComfyUiSettings, normalizeComfyUiSettings } from '@mugen/core'
import {
  defaultModelConfigs,
...
function cloneModelConfig(config: ModelConfig): ModelConfig {
  ...
  return {
    ...
    model,
    models,
    baseUrl: capability.supportsBaseUrl || canUseDevelopmentApimartBaseUrl({ ...config, provider }) ? config.baseUrl : '',
