...
<template>
  <main class="app-shell">
    <section v-if="store.status === 'loading'" class="startup"><span class="spinner" />正在打开 Lightyear Banana</section>
    <section v-else-if="store.status === 'incompatible'" class="startup"><strong>Lightyear Banana 插件需要更新</strong><button type="button" @click="store.openReleasePage">查看更新</button></section>
