...
export async function generateImagesWithLegacyRuntime(params: ImageGenerationParams) {
...
export async function testImageConfigWithLegacyRuntime(config: ModelConfig) {
  if (config.provider === 'comfyui') {
  ...
  await generateImagesWithLegacyRuntime(params)
}
