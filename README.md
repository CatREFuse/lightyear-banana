...
| 内容 | 用途 | 下载 |
| --- | --- | --- |
| macOS 桌面本体 | 运行 Lightyear App | [`lightyear-banana-0.3.0-mac.zip`](https://github.com/CatREFuse/lightyear-banana/releases/download/v0.3.0/lightyear-banana-0.3.0-mac.zip) |
| Windows 桌面本体 | 运行 Lightyear App | [`lightyear-banana-0.3.0-win.zip`](https://github.com/CatREFuse/lightyear-banana/releases/download/v0.3.0/lightyear-banana-0.3.0-win.zip) |
| Photoshop CCX 插件 | 安装 Photoshop 面板 | [`lightyear-banana-0.3.0.ccx`](https://github.com/CatREFuse/lightyear-banana/releases/download/v0.3.0/lightyear-banana-0.3.0.ccx) |
| Codex Image Server Skill | 把本机 Codex 生图能力改造成 HTTP image server | [`skills/codex-image-server/`](https://github.com/CatREFuse/lightyear-banana/tree/v0.3.0/skills/codex-image-server) |
| 仓库源码 | 包含桌面端、插件和 Codex Image Server Skill | [`Source code zip`](https://github.com/CatREFuse/lightyear-banana/archive/refs/tags/v0.3.0.zip) |

同一版本需要下载 2 个运行文件：

- macOS 用户：`lightyear-banana-0.3.0-mac.zip` 和 `lightyear-banana-0.3.0.ccx`
- Windows 用户：`lightyear-banana-0.3.0-win.zip` 和 `lightyear-banana-0.3.0.ccx`

### 1. 安装桌面本体

macOS：

1. 解压 `lightyear-banana-0.3.0-mac.zip`。
2. 把 `Lightyear Banana.app` 拖到“应用程序”文件夹。
3. 打开 `Lightyear Banana.app`。

Windows：

1. 解压 `lightyear-banana-0.3.0-win.zip`。
2. 打开解压后的文件夹。
...
2. 把 `lightyear-banana-0.3.0.ccx` 拖进 Creative Cloud 窗口。
3. 按照弹窗完成安装。
...
也可以从 [`Source code zip`](https://github.com/CatREFuse/lightyear-banana/archive/refs/tags/v0.3.0.zip) 解压后复制 `skills/codex-image-server/`。
...
- `dist/lightyear-banana-0.3.0.ccx`
- `dist/lightyear-banana-0.3.0-mac.zip`
- `dist/lightyear-banana-0.3.0-win.zip`
- `dist/release-0.3.0/`
