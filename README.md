...
- macOS 用户：`lightyear-banana-0.3.11-mac.zip` 和 `lightyear-banana-0.3.11.ccx`
- Windows 用户：`lightyear-banana-0.3.11-win.zip` 和 `lightyear-banana-0.3.11.ccx`

### 1. 安装桌面本体

macOS：

1. 解压 `lightyear-banana-0.3.11-mac.zip`。
2. 把 `Lightyear Banana.app` 拖到“应用程序”文件夹。
3. 打开 `Lightyear Banana.app`。

Windows：

1. 解压 `lightyear-banana-0.3.11-win.zip`。
2. 打开解压后的文件夹。
...
2. 把 `lightyear-banana-0.3.11.ccx` 拖进 Creative Cloud 窗口。
3. 按照弹窗完成安装。
...
- `dist/lightyear-banana-0.3.11.ccx`
- `dist/lightyear-banana-0.3.11-mac.zip`
- `dist/lightyear-banana-0.3.11-win.zip`
- `dist/release-0.3.11/`
