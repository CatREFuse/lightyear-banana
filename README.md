...
| 内容 | 用途 | 下载 |
| --- | --- | --- |
| macOS 桌面本体 | 运行 Lightyear App | [`lightyear-banana-0.3.7-mac.zip`](https://github.com/CatREFuse/lightyear-banana/releases/download/v0.3.7/lightyear-banana-0.3.7-mac.zip) |
| Windows 桌面本体 | 运行 Lightyear App | [`lightyear-banana-0.3.7-win.zip`](https://github.com/CatREFuse/lightyear-banana/releases/download/v0.3.7/lightyear-banana-0.3.7-win.zip) |
| Photoshop CCX 插件 | 安装 Photoshop 面板 | [`lightyear-banana-0.3.7.ccx`](https://github.com/CatREFuse/lightyear-banana/releases/download/v0.3.7/lightyear-banana-0.3.7.ccx) |
| Codex Image Server Skill | 把本机 Codex 生图能力改造成 HTTP image server | [`skills/codex-image-server/`](https://github.com/CatREFuse/lightyear-banana/tree/v0.3.7/skills/codex-image-server) |
| 仓库源码 | 包含桌面端、插件和 Codex Image Server Skill | [`Source code zip`](https://github.com/CatREFuse/lightyear-banana/archive/refs/tags/v0.3.7.zip) |
...
也可以从 [`Source code zip`](https://github.com/CatREFuse/lightyear-banana/archive/refs/tags/v0.3.7.zip) 解压后复制 `skills/codex-image-server/`。
