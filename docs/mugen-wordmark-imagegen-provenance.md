# Mugen wordmark ImageGen provenance

- Generated with the built-in ImageGen tool on 2026-08-12.
- Source request: one exact Latin word, `Mugen`, rendered as a black sumi-ink brush wordmark on a flat `#00ff00` chroma-key background.
...
- Chroma removal: `remove_chroma_key.py` with border sampling, soft matte, and despill.
