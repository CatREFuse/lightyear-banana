...
| Inner WebUI vNext `0.2.3` | 开发中 | 从 Electron UI 源码平移，支持 CCX 与独立浏览器 |
| Photoshop CCX `1.1.6` | 活动 | 插件 ID `com.tanshow.mugen`；固定加载云端 WebUI；继续提供画布、置入、Adobe SecureStorage、原生权限和启动故障日志 |
