...
} from '../../../inner-protocol/src/providerCapabilities'
import {
  CAPABILITY_PROVIDER_IDS,
  providerCapabilityData,
  validateProviderGenerationParameters
} from '../../../inner-protocol/src/providerCapabilityData'
import type { ModelConfig as WebUiModelConfig, ProviderCapability as WebUiProviderCapability } from '../../../inner-protocol/src/index'
